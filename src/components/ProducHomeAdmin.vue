...
<template>
  <div class="container mx-auto p-4">
    ...
    <RouterLink to="/admin/gestion-produits/add">add product</RouterLink>
  </div>
  ...
  >
    ...
    <template #footer>
      <Button label="Non" icon="pi pi-times" @click="displayConfirmationModal = false" text />
      <Button label="Oui" icon="pi pi-check" @click="handleDeleteProduct" severity="danger" text />
    </template>
  </Dialog>
</template>
